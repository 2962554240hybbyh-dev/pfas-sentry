...
|---------|---------|---------|--------|---------|
| NR-AR | 雄激素受体拮抗 | 0.317 | 0.272 | 中 |
| NR-AR-LBD | 配体结合域活性 | 0.385 | 0.198 | 中 |
| NR-AhR | 芳香烃受体激活 | 0.299 | 0.171 | 低 |
| SR-HSE | 热休克元件响应 | 0.462 | 0.293 | 中 |
| SR-MMP | 线粒体膜电位异常 | 0.479 | 0.287 | 中 |
| SR-p53 | p53通路激活 | 0.273 | 0.199 | 低 |
...
### 分子结构包含
- GenX → carboxylic acid group
- GenX → perfluoroalkyl chain
- GenX → ether linkage
