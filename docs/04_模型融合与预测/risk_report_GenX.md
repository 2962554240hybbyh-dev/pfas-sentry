...
|---------|---------|---------|--------|---------|
| NR-AR | 雄激素受体拮抗 | 0.689 | 0.262 | 高 |
| NR-AR-LBD | 配体结合域活性 | 0.354 | 0.306 | 中 |
| NR-AhR | 芳香烃受体激活 | 0.646 | 0.255 | 高 |
| SR-HSE | 热休克元件响应 | 0.548 | 0.306 | 中 |
| SR-MMP | 线粒体膜电位异常 | 0.641 | 0.257 | 高 |
| SR-p53 | p53通路激活 | 0.372 | 0.275 | 中 |
...
- GenX --[contains]--> carboxylic acid group
- GenX --[contains]--> perfluoroalkyl chain
- GenX --[contains]--> ether linkage
- GenX --[has_endpoint]--> NR-AhR
- GenX --[has_endpoint]--> SR-p53
- GenX --[via_mechanism]--> 肝脏毒性
- GenX --[via_mechanism]--> 肾脏毒性
- GenX --[exists_in]--> 饮用水
- GenX --[exists_in]--> 地表水
- GenX --[affects]--> 哺乳动物
- GenX --[causes]--> 肝毒性
