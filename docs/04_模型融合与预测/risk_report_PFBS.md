...
|---------|---------|---------|--------|---------|
| NR-AR | 雄激素受体拮抗 | 0.645 | 0.271 | 高 |
| NR-AR-LBD | 配体结合域活性 | 0.396 | 0.273 | 中 |
| NR-AhR | 芳香烃受体激活 | 0.657 | 0.257 | 高 |
| SR-HSE | 热休克元件响应 | 0.519 | 0.275 | 中 |
| SR-MMP | 线粒体膜电位异常 | 0.644 | 0.262 | 高 |
| SR-p53 | p53通路激活 | 0.510 | 0.325 | 中 |
...
- PFBS --[contains]--> sulfonic acid group
- PFBS --[contains]--> perfluoroalkyl chain
- PFBS --[has_endpoint]--> NR-AhR
- PFBS --[has_endpoint]--> SR-HSE
- PFBS --[via_mechanism]--> 甲状腺激素干扰
- PFBS --[exists_in]--> 饮用水
- PFBS --[exists_in]--> 地表水
- PFBS --[affects]--> 鱼类
- PFBS --[affects]--> 甲壳类
