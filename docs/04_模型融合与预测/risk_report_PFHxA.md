...
|---------|---------|---------|--------|---------|
| NR-AR | 雄激素受体拮抗 | 0.687 | 0.263 | 高 |
| NR-AR-LBD | 配体结合域活性 | 0.343 | 0.303 | 中 |
| NR-AhR | 芳香烃受体激活 | 0.650 | 0.260 | 高 |
| SR-HSE | 热休克元件响应 | 0.539 | 0.284 | 中 |
| SR-MMP | 线粒体膜电位异常 | 0.644 | 0.262 | 高 |
| SR-p53 | p53通路激活 | 0.515 | 0.328 | 中 |
...
- PFHxA --[contains]--> carboxylic acid group
- PFHxA --[contains]--> perfluoroalkyl chain
- PFHxA --[has_endpoint]--> NR-AhR
- PFHxA --[has_endpoint]--> SR-MMP
- PFHxA --[exists_in]--> 饮用水
- PFHxA --[exists_in]--> 地表水
- PFHxA --[affects]--> 鱼类
- PFHxA --[causes]--> 肝毒性
