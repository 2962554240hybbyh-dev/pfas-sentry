...
| NR-AR-LBD | 配体结合域活性 | 0.351 | 0.302 | 中 |
| NR-AhR | 芳香烃受体激活 | 0.648 | 0.256 | 高 |
| SR-HSE | 热休克元件响应 | 0.548 | 0.277 | 中 |
| SR-MMP | 线粒体膜电位异常 | 0.629 | 0.266 | 高 |
| SR-p53 | p53通路激活 | 0.460 | 0.258 | 中 |
...
- ADONA --[contains]--> carboxylic acid group
- ADONA --[contains]--> perfluoroalkyl chain
- ADONA --[has_endpoint]--> NR-AhR
