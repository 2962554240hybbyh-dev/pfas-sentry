...
# PFAS数据库
PFAS_DB = {
    'PFOA': {'smiles': 'OC(=O)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)F', 'name_cn': '全氟辛酸', 'name_en': 'Perfluorooctanoic Acid', 'cas': '335-67-1', 'category': 'PFCA', 'chain': 8, 'toxicity': '高', 'degrade': '难降解', 'bioaccum': '高', 'mol_formula': 'C8HF15O2', 'mol_weight': 414.07},
    'PFOS': {'smiles': 'OS(=O)(=O)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)F', 'name_cn': '全氟辛烷磺酸', 'name_en': 'Perfluorooctane Sulfonic Acid', 'cas': '1763-23-1', 'category': 'PFSA', 'chain': 8, 'toxicity': '高', 'degrade': '难降解', 'bioaccum': '高', 'mol_formula': 'C8HF17O3S', 'mol_weight': 500.13},
    'GenX': {'smiles': 'OC(=O)C(F)(F)OC(F)(F)C(F)(F)OC(F)(F)F', 'name_cn': 'HFPO-DA', 'name_en': 'Hexafluoropropylene Oxide Dimer Acid', 'cas': '13252-13-6', 'category': 'PFECDA', 'chain': 3, 'toxicity': '中', 'degrade': '较难降解', 'bioaccum': '中', 'mol_formula': 'C5HF9O4', 'mol_weight': 296.04},
